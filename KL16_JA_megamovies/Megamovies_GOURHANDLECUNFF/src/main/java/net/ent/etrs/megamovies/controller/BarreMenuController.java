...
public class BarreMenuController extends AbstractController {
    ...
    public void ajouterFilm() {
        chargerScene(this.laBarre.getScene(), Screens.SCREEN_AJOUTER_FILM, new AjouterFilmController(null));
    }
    ...
    @FXML
    public void listerRealisateurs() {
        chargerScene(this.laBarre.getScene(), Screens.SCREEN_LISTER_REALISATEUR, null);
    }
