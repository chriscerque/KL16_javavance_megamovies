package net.ent.etrs.Megamovies_SANTOS.model.start.view.utils;
...
public class FxmlUtils {
    ...
    public static Scene initialiserScene(String name) {
        try {
            ...
            e.printStackTrace();
            net.ent.etrs.projet.model.view.utils.AlerteUtils.afficherMessageDansAlerte("Une erreure s'est produite lors de l''initialisation de la scene.", Alert.AlertType.ERROR);
        }
        return scene;
    }
    ...
    public static void chargerScene(Scene sceneCourante, String screen, Object controller) {
        try {
            ...
            e.printStackTrace();
            net.ent.etrs.projet.model.view.utils.AlerteUtils.afficherMessageDansAlerte("Une erreure s'est produite lors du chargement de la page." + screen, Alert.AlertType.ERROR);
        }
    }
