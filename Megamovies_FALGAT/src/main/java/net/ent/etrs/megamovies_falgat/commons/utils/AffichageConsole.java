...
public final class AffichageConsole {
    ...
    /**
     * Méthode affichant les messages d'erreur de la chaine d'exceptions précédés par la chaine 'Erreur :'.
     *
     * @param ex messages d'erreur à afficher.
     */
    public static void afficherException(final Exception ex) {
//		final String message = String.format("Erreur : %s", msg);
        StringBuilder sb = new StringBuilder(String.format("Erreur : %s", ex.getMessage()));
