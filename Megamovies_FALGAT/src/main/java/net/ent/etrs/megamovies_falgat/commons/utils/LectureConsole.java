...
public final class LectureConsole {
     ...
     * @return l'option saisie.
     */
    public static int lectureChoixInt(final int index1, final int index2, String entete) {
        AffichageConsole.afficherMessageAvecSautLigne(entete);
        return lectureChoixInt(index1, index2);
    }
