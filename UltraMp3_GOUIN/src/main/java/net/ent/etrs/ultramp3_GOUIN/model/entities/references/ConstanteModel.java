package net.ent.etrs.ultramp3_GOUIN.model.entities.references;
...
public class ConstanteModel {
    ...
    public static final String MSG_NOM_TAILLE_MIN_MAX = "Le nom doit contenir au minimum 3 caractères et au maximum 50.";
    public static final String MSG_TITRE_NON_VIDE = "Le titre doit être renseigné.";
    public static final String MSG_TITRE_TAILLE_MAX = "Le nom doit contenir au maximum 150 caractères.";
    public static final String MSG_MUSIQUE_DATESORTIE_NON_NULL = "la date de sortie de la musique doit être renseignée.";
    public static final String PATTERN_EMAIL_SIMPLE = "^(.+)@(\\S.+)$";
    ...
    public static final int COMPOSITEUR_NOM_TAILLE_MIN = 3;
    public static final int COMPOSITEUR_NOM_TAILLE_MAX = 50;

    public static final int MUSIQUE_TITRE_TAILLE_MAX = 150;
    public static final int MUSIQUE_TITRE_TAILLE_MIN = 3;
